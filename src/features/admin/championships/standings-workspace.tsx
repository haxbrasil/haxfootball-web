...
const visibleMetricDefinitions: Array<{
  ...
  { key: "score-for", label: "A favor", className: "hidden w-24 text-center md:table-cell" },
  { key: "score-against", label: "Contra", className: "hidden w-24 text-center md:table-cell" },
  { key: "score-difference", label: "Saldo", className: "w-20 text-center" },
...
function criterionLabel(criterion: Criterion) {
  return {
    ...
    "score-for": "Placar a favor",
    "score-against": "Placar contra",
